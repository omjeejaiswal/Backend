    ...
    const channel = await User.aggregate([
...

        {
            $lookup: {
                from: "subscriptions",
                localField: "_id",
                foreignField: "channel", // channel - from subsciption.models.js
                as: "subscribers"
            }
        },

        {
            $lookup: {
                from: "subscriptions",
                localField: "_id",
                foreignField: "subscriber", // subscriber - from subsciption.models.js
                as:"subscribedTo"
            }
        },
...
const getWatchHistory = asyncHandler(async(req,res) =>{
    ...
    const user = await User.aggregate([
        {
            $match: {
                _id: new mongoose.Types.ObjecId(req.user._id)
            }
        },
        {
            $lookup:{
